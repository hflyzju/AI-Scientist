...
from utils_tool import load_json_from_file, save_json_data_to_file, init_logging
...
def parse_arguments():
    ...
    parser.add_argument(
        "--use_only_problem_and_method_for_review",
        type=int,
        default=0,
        help="Input is Paper or Problem and Method.",
    )
...
if __name__ == "__main__":
    init_logging(log_dir="log", log_filename="log.txt")
    ...
    rating_fname += f"_num_reviews_{args.num_reviews}"
